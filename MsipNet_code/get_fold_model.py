...
from utils.utils import read_csv, myDataset, GradualWarmupScheduler, split_dataset, seq2mer
...
def main(args):
    ...
    if args.train:
        ...
        print("FM_embeddins:", embeddings.shape)
        ...
        for fold, (train_idx, val_idx) in enumerate(kf.split(samples)):
            #Save the model from a specific fold in five-fold cross-validation
            if fold+1==5:
                ...
                for epoch in range(1, 200):
                    ...
                    line = '{} \t Train Epoch: {}     avg.loss: {:.4f} ACC: {:.2f}%, PR: {:.4f}, Recall: {:.4f}, Specificity: {:.4f}, MCC: {:.4f} ,F1-socre: {:.4f}, AUC: {:.4f}, AP: {:.4f} lr: {:.6f}'.format(
                        ...
                        t_met.mcc,
                        t_met.f1_score, t_met.auc, t_met.prc, lr)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--fm_path', default='./FM_embedding', type=str,
