...
from Utils.utils import read_csv, myDataset, GradualWarmupScheduler, seq2mer, RNAshapes_to_onehot, read_fasta_with_RNAshapes
from sklearn.model_selection import KFold
from Utils.MsipNet_RNAshapes import MsipNet
...
def main(args):
    ...
    if args.train:
        ...
        _, structures, _ = read_fasta_with_RNAshapes("./RNAshapes/" + file_name + ".txt")
        structure = RNAshapes_to_onehot(structures)
        print("RNAshapes:",structure.shape)
    ...
    if args.train_all:
        ...
        for file_name in file_names:
            ...
            _, structures, _ = read_fasta_with_RNAshapes(
                "./RNAshapes/" + file_name + ".txt")
            structure = RNAshapes_to_onehot(structures)
            print("RNAshapes:", structure.shape)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_save_path', default='./RNAshapes_model', type=str,
                        help='Save the trained model')
    parser.add_argument('--result_save_path', default='./RNAshapes_results', type=str,
